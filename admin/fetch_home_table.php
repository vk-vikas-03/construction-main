...
$q = "SELECT * FROM  home ORDER BY event_id ASC LIMIT $start_from, " . $results_per_page;
...
<div class="container">
    <div class="row">
        <div class="offset-sm-4 col-sm-2">
            <div class="row">
                <div class="col">
                    <a href="add_home.php"><button class="btn btn-danger">Add Home</button></a>
                </div>
            </div>
        </div>
    </div>
...
<table class="table table-striped" border="1" id="myTable">
    ...
    ?>
        <tr>
            ...
            <td> <img src="images/<?php echo $r[1]; ?>" height="100px" width="100px" /></td>
